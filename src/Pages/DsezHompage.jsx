export default function DSEZHomepage() {
  ...
  return (
    <div className="font-sans bg-[#f9f9f9] text-[#1a1c1c] min-h-screen">
      <style>{`
        ...
        * { font-family: 'DM Sans', sans-serif; }
        ...
        .animate-fadeInDown { animation: fadeInDown 0.18s ease both; }
        @keyframes fadeUp {
        ...
        .video-overlay { background: linear-gradient(105deg, rgba(0,30,64,0.88) 0%, rgba(0,30,64,0.45) 55%, rgba(0,30,64,0.1) 100%); }
        .bento-card-hover { transition: transform 0.35s cubic-bezier(.4,0,.2,1), box-shadow 0.35s; }
        .bento-card-hover:hover { transform: translateY(-4px); box-shadow: 0 24px 48px rgba(0,30,64,0.13); }
        .news-img { transition: transform 0.65s cubic-bezier(.4,0,.2,1); }
        .news-card:hover .news-img { transform: scale(1.08); }
        input:focus { outline: none; }
        ::-webkit-scrollbar { width: 6px; }
        ::-webkit-scrollbar-track { background: #f1f1f1; }
        ::-webkit-scrollbar-thumb { background: #001e40; border-radius: 3px; }
      `}</style>
